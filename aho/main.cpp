...
class aho_corasick
{
    ...
    //private:
        ...
        trie_node* step( char character, int index, trie_node* curent_state);
};
...
void aho_corasick::find_all_entries( std::string text) 
{
    ...
    {
        current_state = step( *c, index, current_state);
    }
}

trie_node* aho_corasick::step( char character, int index, trie_node* current_state)
{
